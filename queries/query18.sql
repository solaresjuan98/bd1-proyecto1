...
select distinct client.CLIENT_CODE,
...
select distinct CLIENT_CODE, count(*)
from MOVIE_RENTAL
group by CLIENT_CODE;

select CLIENT_CODE, count(*), count(*) over ()
from RENTAL_DETAIL
    join MOVIE_RENTAL MR on MR.RENTAL_CODE = RENTAL_DETAIL.RENTAL_CODE
group by CLIENT_CODE
;
