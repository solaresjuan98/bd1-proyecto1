...
-- INSERT BILL / MASTER DETAIL TABLES

SELECT RENTAL_BILL.RENTAL_CODE, MOVIE.MOVIE_CODE, RETURN_DATE, MOUNT_TO_PAY
FROM TEMPORAL_TABLE,
    RENTAL_BILL,
    MOVIE
...
not in '-'
   or TEMPORAL_TABLE.PAY_DATE not in '-';


-- INSERT MASTER_DETAIL TABLE
SELECT DISTINCT RENTAL_BILL.RENTAL_CODE, MOVIE.MOVIE_CODE, TEMPORAL_TABLE.RETURN_DATE, TEMPORAL_TABLE.MOUNT_TO_PAY
FROM TEMPORAL_TABLE,
    RENTAL_BILL,
    MOVIE
WHERE TEMPORAL_TABLE.SALE_DATE = to_char(RENTAL_BILL.RENTAL_DATE, 'DD/MM/YYYY HH24:MI')
